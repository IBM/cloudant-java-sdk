...
public class PartitionViewPagination {
  ...
  public static void main(String[] args) {
    ...
    // Setup options
    PostPartitionViewOptions options = new PostPartitionViewOptions.Builder()
    ...
    // Create pagination
    Pagination<PostPartitionViewOptions, ViewResultRow> pagination = Pagination.newPagination(service, options);
    ...
    for (List<ViewResultRow> page : pagination.pages()) {
    ...
    Pager<ViewResultRow> pagePager = pagination.pager();
    if (pagePager.hasNext()) {
      List<ViewResultRow> page = pagePager.getNext();
      // Do something with page
    }
    ...
    Pager<ViewResultRow> allPager = pagination.pager();
    List<ViewResultRow> allRows = allPager.getAll();
    for (ViewResultRow row : allRows) {
      // Do something with row
    }
