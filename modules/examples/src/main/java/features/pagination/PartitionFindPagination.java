...
public class PartitionFindPagination {
  ...
  public static void main(String[] args) {
    ...
    // Setup options
    PostPartitionFindOptions options = new PostPartitionFindOptions.Builder()
      ...
      .fields(List.of("productId", "eventType", "date")) // return these fields
      .selector(Collections.singletonMap("userId", "abc123")) // select documents with "userId" field equal to "abc123"
      .build();

    // Create pagination
    Pagination<PostPartitionFindOptions, Document> pagination = Pagination.newPagination(service, options);
