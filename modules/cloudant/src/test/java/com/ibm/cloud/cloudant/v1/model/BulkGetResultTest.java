...
/**
 * Unit test class for the BulkGetResult model.
 */
public class BulkGetResultTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBulkGetResult() throws Throwable {
    BulkGetResult bulkGetResultModel = new BulkGetResult();
    assertNull(bulkGetResultModel.getResults());
  }
}