...
/**
 * Unit test class for the BulkGetResultItem model.
 */
public class BulkGetResultItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBulkGetResultItem() throws Throwable {
    BulkGetResultItem bulkGetResultItemModel = new BulkGetResultItem();
    assertNull(bulkGetResultItemModel.getDocs());
    assertNull(bulkGetResultItemModel.getId());
  }
}