...
public class DesignDocsTest extends
    PaginationOperationTest<PostDesignDocsOptions.Builder, AllDocsResult, PostDesignDocsOptions, DocsResultRow> {

  DesignDocsTest() {
    super(new PageSupplierFactory<AllDocsResult, DocsResultRow>(TestAllDocsResult::new, TestDocsResultRow::new,
        true), OptionsWrapper.POST_DESIGN_DOCS.newProvider(), true);
  }

  // New Pagination
  @Override
  protected Pagination<PostDesignDocsOptions, DocsResultRow> makeNewPagination(
      MockCloudant<AllDocsResult> cloudant, PostDesignDocsOptions options) {
