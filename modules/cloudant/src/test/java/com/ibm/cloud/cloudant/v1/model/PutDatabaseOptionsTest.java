...
/**
 * Unit test class for the PutDatabaseOptions model.
 */
public class PutDatabaseOptionsTest {
  ...
  public void testPutDatabaseOptionsError() throws Throwable {
    new PutDatabaseOptions.Builder().build();
  }
