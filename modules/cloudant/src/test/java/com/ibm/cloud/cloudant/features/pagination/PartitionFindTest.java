...
public class PartitionFindTest extends
    PaginationOperationTest<PostPartitionFindOptions.Builder, FindResult, PostPartitionFindOptions, Document> {

    PartitionFindTest() {
      super(new PageSupplierFactory<FindResult, Document>(TestFindResult::new, TestFindDocument::new,
          false), OptionsWrapper.POST_PARTITION_FIND.newProvider(), false);
    }

  // New Pagination
  @Override
  protected Pagination<PostPartitionFindOptions, Document> makeNewPagination(
      MockCloudant<FindResult> cloudant, PostPartitionFindOptions options) {
