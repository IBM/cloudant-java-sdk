...
/**
 * Unit test class for the PostGeoCleanupOptions model.
 */
public class PostGeoCleanupOptionsTest {
  ...
  public void testPostGeoCleanupOptionsError() throws Throwable {
    new PostGeoCleanupOptions.Builder().build();
  }
