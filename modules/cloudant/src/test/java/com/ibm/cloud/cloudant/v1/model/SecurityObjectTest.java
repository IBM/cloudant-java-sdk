...
/**
 * Unit test class for the SecurityObject model.
 */
public class SecurityObjectTest {
  ...
  public void testSecurityObject() throws Throwable {
    ...
    SecurityObject securityObjectModelNew = TestUtilities.deserialize(json, SecurityObject.class);
    assertTrue(securityObjectModelNew instanceof SecurityObject);
  }
}