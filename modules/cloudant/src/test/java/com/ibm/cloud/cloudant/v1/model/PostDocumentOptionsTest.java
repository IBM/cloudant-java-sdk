...
/**
 * Unit test class for the PostDocumentOptions model.
 */
public class PostDocumentOptionsTest {
  ...
  public void testPostDocumentOptionsError() throws Throwable {
    new PostDocumentOptions.Builder().build();
  }
