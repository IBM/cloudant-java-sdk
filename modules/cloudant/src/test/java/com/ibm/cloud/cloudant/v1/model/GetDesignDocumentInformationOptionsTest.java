...
/**
 * Unit test class for the GetDesignDocumentInformationOptions model.
 */
public class GetDesignDocumentInformationOptionsTest {
  ...
  public void testGetDesignDocumentInformationOptionsError() throws Throwable {
    new GetDesignDocumentInformationOptions.Builder().build();
  }
