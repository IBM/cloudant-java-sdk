...
public class PartitionViewTest extends
    PaginationOperationTest<PostPartitionViewOptions.Builder, ViewResult, PostPartitionViewOptions, ViewResultRow> {

  PartitionViewTest() {
    super(new PageSupplierFactory<ViewResult, ViewResultRow>(TestViewResult::new, TestViewResultRow::new, 
        true), OptionsWrapper.POST_PARTITION_VIEW.newProvider(), true);
  }

  // New Pagination
  @Override
  protected Pagination<PostPartitionViewOptions, ViewResultRow> makeNewPagination(
      MockCloudant<ViewResult> cloudant, PostPartitionViewOptions options) {
