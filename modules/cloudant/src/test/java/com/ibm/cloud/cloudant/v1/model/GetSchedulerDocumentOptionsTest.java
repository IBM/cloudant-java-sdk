...
/**
 * Unit test class for the GetSchedulerDocumentOptions model.
 */
public class GetSchedulerDocumentOptionsTest {
  ...
  public void testGetSchedulerDocumentOptionsError() throws Throwable {
    new GetSchedulerDocumentOptions.Builder().build();
  }
