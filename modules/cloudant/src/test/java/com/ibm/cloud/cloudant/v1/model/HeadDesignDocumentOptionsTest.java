...
/**
 * Unit test class for the HeadDesignDocumentOptions model.
 */
public class HeadDesignDocumentOptionsTest {
  ...
  public void testHeadDesignDocumentOptionsError() throws Throwable {
    new HeadDesignDocumentOptions.Builder().build();
  }
