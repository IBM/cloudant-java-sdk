...
/**
 * Unit test class for the DeleteDesignDocumentOptions model.
 */
public class DeleteDesignDocumentOptionsTest {
  ...
  public void testDeleteDesignDocumentOptionsError() throws Throwable {
    new DeleteDesignDocumentOptions.Builder().build();
  }
