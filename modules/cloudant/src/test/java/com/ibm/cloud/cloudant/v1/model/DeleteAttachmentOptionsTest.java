...
/**
 * Unit test class for the DeleteAttachmentOptions model.
 */
public class DeleteAttachmentOptionsTest {
  ...
  public void testDeleteAttachmentOptionsError() throws Throwable {
    new DeleteAttachmentOptions.Builder().build();
  }
