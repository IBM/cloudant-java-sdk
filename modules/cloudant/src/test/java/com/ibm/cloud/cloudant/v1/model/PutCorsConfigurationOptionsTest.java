...
/**
 * Unit test class for the PutCorsConfigurationOptions model.
 */
public class PutCorsConfigurationOptionsTest {
  ...
  public void testPutCorsConfigurationOptions() throws Throwable {
    PutCorsConfigurationOptions putCorsConfigurationOptionsModel = new PutCorsConfigurationOptions.Builder()
      ...
      .enableCors(true)
      .build();
    assertEquals(putCorsConfigurationOptionsModel.origins(), java.util.Arrays.asList("testString"));
