...
/**
 * Unit test class for the ReplicationDatabaseAuthIam model.
 */
public class ReplicationDatabaseAuthIamTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplicationDatabaseAuthIam() throws Throwable {
    ...
    String json = TestUtilities.serialize(replicationDatabaseAuthIamModel);

    ReplicationDatabaseAuthIam replicationDatabaseAuthIamModelNew = TestUtilities.deserialize(json, ReplicationDatabaseAuthIam.class);
