...
public class PartitionAllDocsTest extends
    PaginationOperationTest<PostPartitionAllDocsOptions.Builder, AllDocsResult, PostPartitionAllDocsOptions, DocsResultRow> {
  ...
  PartitionAllDocsTest() {
    super(new PageSupplierFactory<AllDocsResult, DocsResultRow>(TestAllDocsResult::new, TestDocsResultRow::new,
        true), OptionsWrapper.POST_PARTITION_ALL_DOCS.newProvider(), true);
  }

  // New Pagination
  @Override
  protected Pagination<PostPartitionAllDocsOptions, DocsResultRow> makeNewPagination(
      MockCloudant<AllDocsResult> cloudant, PostPartitionAllDocsOptions options) {
