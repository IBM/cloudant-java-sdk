...
/**
 * Unit test class for the DeleteLocalDocumentOptions model.
 */
public class DeleteLocalDocumentOptionsTest {
  ...
  public void testDeleteLocalDocumentOptionsError() throws Throwable {
    new DeleteLocalDocumentOptions.Builder().build();
  }
