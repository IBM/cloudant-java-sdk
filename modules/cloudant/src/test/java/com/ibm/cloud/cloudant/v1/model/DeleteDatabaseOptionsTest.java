...
/**
 * Unit test class for the DeleteDatabaseOptions model.
 */
public class DeleteDatabaseOptionsTest {
  ...
  public void testDeleteDatabaseOptionsError() throws Throwable {
    new DeleteDatabaseOptions.Builder().build();
  }
