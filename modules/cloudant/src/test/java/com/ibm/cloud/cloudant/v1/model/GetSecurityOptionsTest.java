...
/**
 * Unit test class for the GetSecurityOptions model.
 */
public class GetSecurityOptionsTest {
  ...
  public void testGetSecurityOptionsError() throws Throwable {
    new GetSecurityOptions.Builder().build();
  }
