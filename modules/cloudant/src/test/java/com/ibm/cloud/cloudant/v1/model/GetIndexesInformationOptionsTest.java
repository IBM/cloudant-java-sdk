...
/**
 * Unit test class for the GetIndexesInformationOptions model.
 */
public class GetIndexesInformationOptionsTest {
  ...
  public void testGetIndexesInformationOptionsError() throws Throwable {
    new GetIndexesInformationOptions.Builder().build();
  }
