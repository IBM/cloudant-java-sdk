...
- [Example request](./getGeo/example_request.java)

## getGeoIndexInformation

### get `/{db}/_design/{ddoc}/_geo_info/{index}`

- [Example request](./getGeoIndexInformation/example_request.java)
...
- [Example request](./postGeoCleanup/example_request.java)
