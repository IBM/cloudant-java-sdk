...
- Built-in [Changes feed follower](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs/Changes_Follower.md)
- Built-in [Pagination](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs/Pagination.md) (beta)
...
1. As [environment variables](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs/Authentication.md#authentication-with-environment-variables)
2. The [programmatic approach](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs/Authentication.md#programmatic-authentication)
3. With an [external credentials file](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs/Authentication.md#authentication-with-external-configuration)
...
Consult the [authentication document](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs/Authentication.md)
...
[More tutorial examples](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs/Examples.md) for creating a database
...
The [update document](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs/Examples.md#3-update-your-previously-created-document) section
...
- [Cloudant Java SDK feature docs](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.6/docs)
