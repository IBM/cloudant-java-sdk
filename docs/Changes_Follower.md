...
[POST `_changes` API](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.17/examples#postchanges) instead of the follower.
...
In these use-cases use the SDK's [POST `_changes` API](https://github.com/IBM/cloudant-java-sdk/tree/v0.10.17/examples#postchanges)
